...
filename = ["inlet", "intake_manifold", "outlet_left", "outlet_right"]
file = [pkgdir(TrixiParticles, "examples", "preprocessing", "data", name * ".stl") for name in filename]
